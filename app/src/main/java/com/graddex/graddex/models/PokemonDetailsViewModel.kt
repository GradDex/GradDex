                    ...
                    override fun onResponse(call: Call, response: Response) {
                        ...
                        if (evolutionChain != null) {
                            ...
                            if (speciesRes.evolves_from_species != null) {
                                val previousEvolution = mutableListOf(speciesRes.evolves_from_species.name)
                            ...
                            client.newCall(evolutionRequest).enqueue(object : Callback {
                                ...
                                override fun onResponse(call: Call, response: Response) {
                                    ...
                                    if (evolutionRes!!.chain.evolves_to.isNotEmpty()) {
                                        ...
                                        val nextEvolution = findNextEvolution(detailsRes.name, evolutionNameList, evolutionUrlList)
                                    }
                                }
                            })
                        }
